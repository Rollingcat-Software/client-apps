...
OPENCV_MODULES:=stitching aruco bgsegm bioinspired dnn_superres face img_hash intensity_transform mcc quality rapid saliency structured_light phase_unwrapping superres optflow text tracking highgui plot videostab videoio wechat_qrcode objdetect xfeatures2d shape ml ximgproc video calib3d imgcodecs features2d dnn flann xphoto photo imgproc core
...
ifeq ($(OPENCV_LIB_TYPE),SHARED)
    OPENCV_LIBS:=stitching aruco bgsegm bioinspired dnn_superres face img_hash intensity_transform mcc quality rapid saliency structured_light phase_unwrapping superres optflow text tracking highgui plot videostab videoio wechat_qrcode objdetect xfeatures2d shape ml ximgproc video calib3d imgcodecs features2d dnn flann xphoto photo imgproc core
    OPENCV_LIB_TYPE:=SHARED
else
