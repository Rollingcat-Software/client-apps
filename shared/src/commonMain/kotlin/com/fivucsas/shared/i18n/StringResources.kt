...
private val trStrings = mapOf(
    ...
    StringKey.VOICE_SEARCH_SUBTITLE to "Kayitli konusmacilari aramak icin sesinizi kaydedin",
    StringKey.VOICE_SEARCH_PASSPHRASE_LABEL to "Daha iyi kalite icin bunu sesli okuyun:",
    StringKey.VOICE_SEARCH_WHO_IS_THIS to "Bu Kim?",
    StringKey.VOICE_SEARCH_RESULTS to "Arama Sonuclari",
    StringKey.VOICE_SEARCH_BEST_MATCH to "En Iyi Eslesme",
    StringKey.VOICE_SEARCH_SIMILARITY to "Benzerlik",
    StringKey.VOICE_SEARCH_SPEAKER_IDENTIFIED to "Konusmaci Tanimlandi",
    StringKey.VOICE_SEARCH_NO_MATCH to "Eslesen konusmaci bulunamadi",
    StringKey.VOICE_SEARCH_RECORDING_READY to "Kayit hazir",
    StringKey.VOICE_SEARCH_RESET to "Sifirla",
    ...
    // Multi-Step Auth Flow
    StringKey.MULTI_STEP_AUTH_TITLE to "Kimliginizi Dogrulayin",
    StringKey.MULTI_STEP_SKIP to "Bu adimi atla",
    StringKey.MULTI_STEP_COUNTER to "Adim {0} / {1}",
    StringKey.MULTI_STEP_REQUIRED to "Zorunlu",
    StringKey.MULTI_STEP_VERIFYING to "Dogrulaniyor...",
    StringKey.MULTI_STEP_COMPLETE to "Kimlik Dogrulama Tamamlandi",
    StringKey.MULTI_STEP_COMPLETE_DESC to "Tum dogrulama adimlari basariyla tamamlandi.",
    StringKey.MULTI_STEP_DESC_PASSWORD to "Kimliginizi dogrulamak icin hesap sifrenizi girin.",
    StringKey.MULTI_STEP_DESC_FACE to "Yuz tanima dogrulamasi icin kameranizi kullanin.",
    StringKey.MULTI_STEP_DESC_VOICE to "Ses tanima ile kimliginizi dogrulamak icin konusun.",
    StringKey.MULTI_STEP_DESC_TOTP to "Dogrulama uygulamanizdan gelen kodu girin.",
    StringKey.MULTI_STEP_DESC_EMAIL_OTP to "E-postaniza bir dogrulama kodu gonderilecek.",
    StringKey.MULTI_STEP_DESC_SMS_OTP to "SMS ile bir dogrulama kodu gonderilecek.",
    StringKey.MULTI_STEP_DESC_QR_CODE to "Dogrulama cihazinizla QR kodu tarayin.",
    StringKey.MULTI_STEP_DESC_FINGERPRINT to "Dogrulama icin cihaz biyometriginizi kullanin.",
    StringKey.MULTI_STEP_DESC_HARDWARE_KEY to "Guvenlik anahtarinizi takin ve etkinlestirin.",
    StringKey.MULTI_STEP_DESC_NFC to "NFC belgenizi cihaza yaklastirin.",
    StringKey.MULTI_STEP_ACTION_PASSWORD to "Sifreyi Dogrula",
    StringKey.MULTI_STEP_ACTION_FACE to "Yuz Taramasi Baslat",
    StringKey.MULTI_STEP_ACTION_VOICE to "Ses Kaydini Baslat",
    StringKey.MULTI_STEP_ACTION_TOTP to "Kodu Dogrula",
    StringKey.MULTI_STEP_ACTION_EMAIL_OTP to "Kod Gonder ve Dogrula",
    StringKey.MULTI_STEP_ACTION_SMS_OTP to "Kod Gonder ve Dogrula",
    StringKey.MULTI_STEP_ACTION_QR_CODE to "QR Kodu Tara",
    StringKey.MULTI_STEP_ACTION_FINGERPRINT to "Biyometrik Dogrula",
    StringKey.MULTI_STEP_ACTION_HARDWARE_KEY to "Guvenlik Anahtarini Etkinlestir",
    StringKey.MULTI_STEP_ACTION_NFC to "NFC Belge Oku",

    // Step-Up Authentication (P2.4)
    StringKey.STEP_UP_TITLE to "Ek Dogrulama Gerekli",
    StringKey.STEP_UP_SUBTITLE to "Bu islem guvenlik icin ek dogrulama gerektiriyor.",
    StringKey.STEP_UP_REASON to "Neden: {0}",
    StringKey.STEP_UP_SELECT_METHOD to "Dogrulama yontemi secin",
    StringKey.STEP_UP_METHOD_FINGERPRINT to "Parmak Izi",
    StringKey.STEP_UP_METHOD_FACE to "Yuz Tanima",
    StringKey.STEP_UP_METHOD_TOTP to "Dogrulama Kodu",
    StringKey.STEP_UP_VERIFYING to "Dogrulaniyor...",
    StringKey.STEP_UP_SUCCESS to "Dogrulama basarili!",
    StringKey.STEP_UP_FAILED to "Dogrulama basarisiz. Lutfen tekrar deneyin.",
    StringKey.STEP_UP_CONTINUE to "Devam Et",

    // Role Management (P2.5)
    StringKey.ROLES_TITLE to "Rol Yonetimi",
    StringKey.ROLES_SUBTITLE to "Rolleri ve izinlerini yonetin",
    StringKey.ROLE_NAME to "Rol Adi",
    StringKey.ROLE_DESCRIPTION to "Aciklama",
    StringKey.ROLE_PERMISSION_COUNT to "{0} izin",
    StringKey.ROLE_CREATE to "Rol Olustur",
    StringKey.ROLE_EDIT to "Rolu Duzenle",
    StringKey.ROLE_DELETE to "Rolu Sil",
    StringKey.ROLE_SAVE to "Rolu Kaydet",
    StringKey.ROLE_CONFIRM_DELETE to "Bu rolu silmek istediginizden emin misiniz? Bu role sahip kullanicilar izinlerini kaybedecek.",
    StringKey.ROLE_CREATED to "Rol basariyla olusturuldu",
    StringKey.ROLE_UPDATED to "Rol basariyla guncellendi",
    StringKey.ROLE_DELETED to "Rol basariyla silindi",
    StringKey.NO_ROLES to "Tanimlanmis rol yok",
    StringKey.PERMISSIONS_TITLE to "Izinler",
    StringKey.PERMISSIONS_SELECT to "Bu rol icin izinleri secin",
    StringKey.PERMISSION_CATEGORY_USER to "Kullanici",
    StringKey.PERMISSION_CATEGORY_ENROLLMENT to "Kayit",
    StringKey.PERMISSION_CATEGORY_AUDIT to "Denetim",
    StringKey.PERMISSION_CATEGORY_TENANT to "Kiraci",
    StringKey.PERMISSION_CATEGORY_PLATFORM to "Platform",
    StringKey.PERMISSION_CATEGORY_OTHER to "Diger",

    // Audit Log Dashboard (P2.6)
    StringKey.AUDIT_DASHBOARD_TITLE to "Denetim Gunlugu Panosu",
    StringKey.AUDIT_DASHBOARD_SUBTITLE to "Tum sistem denetim gunluklerini goruntuleyin ve filtreleyin",
    StringKey.AUDIT_FILTER_ACTION to "Islem Turu",
    StringKey.AUDIT_FILTER_USER to "Kullanici ID",
    StringKey.AUDIT_FILTER_DATE_FROM to "Baslangic Tarihi",
    StringKey.AUDIT_FILTER_DATE_TO to "Bitis Tarihi",
    StringKey.AUDIT_APPLY_FILTERS to "Filtreleri Uygula",
    StringKey.AUDIT_CLEAR_FILTERS to "Temizle",
    StringKey.AUDIT_COLUMN_TIMESTAMP to "Zaman Damgasi",
    StringKey.AUDIT_COLUMN_ACTION to "Islem",
    StringKey.AUDIT_COLUMN_USER to "Kullanici",
    StringKey.AUDIT_COLUMN_IP to "IP Adresi",
    StringKey.AUDIT_COLUMN_DETAILS to "Detaylar",
    StringKey.AUDIT_COLUMN_STATUS to "Durum",
    StringKey.AUDIT_LOAD_MORE to "Daha Fazla Yukle",
    StringKey.NO_AUDIT_LOGS to "Denetim gunlugu bulunamadi",
)
