...
private val trStrings = mapOf(
    ...
    // Verification Pipeline (Phase 2.2)
    StringKey.VERIFICATION_DASHBOARD_TITLE to "Dogrulama Oturumlari",
    StringKey.VERIFICATION_DASHBOARD_SUBTITLE to "Kimlik dogrulama oturumlarini ve sonuclarini takip edin",
    StringKey.VERIFICATION_NO_SESSIONS to "Dogrulama oturumu yok",
    StringKey.VERIFICATION_SESSION to "Dogrulama Oturumu",
    StringKey.VERIFICATION_SESSION_ID to "Oturum ID",
    StringKey.VERIFICATION_USER_ID to "Kullanici ID",
    StringKey.VERIFICATION_STARTED to "Basladi",
    StringKey.VERIFICATION_COMPLETED_AT to "Tamamlandi",
    StringKey.VERIFICATION_LEVEL to "Dogrulama Seviyesi",
    StringKey.VERIFICATION_PROGRESS to "Ilerleme",
    StringKey.VERIFICATION_STEPS to "Dogrulama Adimlari",
    StringKey.VERIFICATION_CONFIDENCE to "Guven",
    StringKey.VERIFICATION_STEP_SKIPPED to "ATLANDI",
    StringKey.VERIFICATION_STATUS_PENDING to "BEKLEMEDE",
    StringKey.VERIFICATION_STATUS_IN_PROGRESS to "DEVAM EDIYOR",
    StringKey.VERIFICATION_STATUS_COMPLETED to "TAMAMLANDI",
    StringKey.VERIFICATION_STATUS_FAILED to "BASARISIZ",
    StringKey.VERIFICATION_STATUS_EXPIRED to "SURESI DOLDU",
    StringKey.VERIFICATION_FILTER_ALL to "Tumu",
    StringKey.NAV_VERIFICATION to "Dogrulama",

    // Widget Demo (Phase 3.2)
    StringKey.WIDGET_DEMO_TITLE to "Kimlik Dogrulama Widget Demosu",
    StringKey.WIDGET_DEMO_DESCRIPTION to "Ucuncu taraf entegrasyonu icin gomulu kimlik dogrulama bileseni. Sifir bagimliliktaki SDK.",
    StringKey.WIDGET_DEMO_AUTH_METHODS to "Dogrulama Yontemleri",
    StringKey.WIDGET_DEMO_SDK_SIZE to "SDK Boyutu",
    StringKey.WIDGET_DEMO_DEPENDENCIES to "Bagimliliklar",
    StringKey.WIDGET_DEMO_OIDC_COMPATIBLE to "OIDC Uyumlu",
    StringKey.WIDGET_DEMO_ARCHITECTURE to "Mimari",
    StringKey.WIDGET_DEMO_ARCHITECTURE_DESC to "Uc katmanli mimari: SDK entegrasyonu, sunucu orkestrasyon ve biyometrik yakalama.",
    StringKey.WIDGET_DEMO_SUPPORTED_METHODS to "Desteklenen Dogrulama Yontemleri",
    StringKey.WIDGET_DEMO_INTEGRATION_EXAMPLES to "Entegrasyon Ornekleri",
    StringKey.WIDGET_DEMO_TAB_HTML to "HTML / Script",
    StringKey.WIDGET_DEMO_TAB_JS to "JavaScript",
    StringKey.WIDGET_DEMO_TAB_REACT to "React",
    StringKey.WIDGET_DEMO_HTML_DESC to "SDK'yi script etiketi ile ekleyin ve web bileseni ile olay dinleyicileri kullanin.",
    StringKey.WIDGET_DEMO_JS_DESC to "Modal veya satir ici gomme icin Promise tabanli API ile programatik JavaScript SDK.",
    StringKey.WIDGET_DEMO_REACT_DESC to "Satir ici dogrulama akisi icin hook'lu React bileseni.",
    StringKey.WIDGET_DEMO_COPY to "Kopyala",
    StringKey.NAV_WIDGET_DEMO to "Widget Demo",

    // Developer Portal
    StringKey.DEV_PORTAL_TITLE to "Gelistirici Portali",
    StringKey.DEV_PORTAL_SUBTITLE to "OAuth2 uygulamalarinizi kaydedin ve yonetin.",
    StringKey.DEV_PORTAL_REGISTER_APP to "Uygulama Kaydet",
    StringKey.DEV_PORTAL_NO_APPS to "Kayitli Uygulama Yok",
    StringKey.DEV_PORTAL_NO_APPS_HINT to "Baslamak icin ilk OAuth2 uygulamanizi kaydedin.",
    StringKey.DEV_PORTAL_APP_NAME to "Uygulama Adi",
    StringKey.DEV_PORTAL_CLIENT_ID to "Istemci Kimli\u011fi",
    StringKey.DEV_PORTAL_CLIENT_SECRET to "Istemci Sifresi",
    StringKey.DEV_PORTAL_SCOPES to "Kapsamlar",
    StringKey.DEV_PORTAL_CREATED to "Olusturulma",
    StringKey.DEV_PORTAL_STATUS_ACTIVE to "Aktif",
    StringKey.DEV_PORTAL_STATUS_INACTIVE to "Pasif",
    StringKey.DEV_PORTAL_REDIRECT_URIS to "Yonlendirme URI'leri",
    StringKey.DEV_PORTAL_REDIRECT_URIS_HELPER to "Virgul ile ayrilmis izin verilen yonlendirme URI'leri.",
    StringKey.DEV_PORTAL_ALLOWED_SCOPES to "Izin Verilen Kapsamlar",
    StringKey.DEV_PORTAL_REGISTER to "Kaydet",
    StringKey.DEV_PORTAL_COPY to "Kopyala",
    StringKey.DEV_PORTAL_COPY_CLIENT_ID to "Istemci Kimligini Kopyala",
    StringKey.DEV_PORTAL_COPIED to "Kopyalandi!",
    StringKey.DEV_PORTAL_COPIED_TO_CLIPBOARD to "Panoya kopyalandi",
    StringKey.DEV_PORTAL_APP_CREATED to "Uygulama Olusturuldu!",
    StringKey.DEV_PORTAL_SECRET_WARNING to "Istemci sifrenizi simdi kaydedin. Tekrar gosterilmeyecektir.",
    StringKey.DEV_PORTAL_DONE to "Tamam",
    StringKey.DEV_PORTAL_DELETE_APP to "Uygulamayi Sil",
    StringKey.DEV_PORTAL_DELETE_CONFIRM to "\"{0}\" uygulamasini silmek istediginizden emin misiniz? Bu islem geri alinamaz.",
    StringKey.DEV_PORTAL_DELETE_SUCCESS to "Uygulama basariyla silindi.",
    StringKey.DEV_PORTAL_QUICK_START to "Hizli Baslangic Rehberi",
    StringKey.DEV_PORTAL_QUICK_START_DESC to "FIVUCSAS kimlik dogrulamasini 3 adimda uygulamaniza entegre edin.",
    StringKey.DEV_PORTAL_STEP1_TITLE to "Uygulamanizi Kaydedin",
    StringKey.DEV_PORTAL_STEP1_DESC to "Yukaridaki \"Uygulama Kaydet\" butonuna tiklayip uygulama adi, yonlendirme URI'leri ve kapsamlari girin.",
    StringKey.DEV_PORTAL_STEP2_TITLE to "Widget'i Ekleyin",
    StringKey.DEV_PORTAL_STEP2_DESC to "Kimlik dogrulama widget betigini web sitenize ekleyin.",
    StringKey.DEV_PORTAL_STEP3_TITLE to "Geri Aramayi Isleyin",
    StringKey.DEV_PORTAL_STEP3_DESC to "Geri arama sayfanizda yetkilendirme kodunu token ile degistirin.",
    StringKey.NAV_DEVELOPER_PORTAL to "Gelistirici Portali",

    // MFA Flow
    StringKey.MFA_TITLE to "Cok Faktorlu Kimlik Dogrulama",
    StringKey.MFA_STEP_COUNTER to "Adim {0} / {1}",
    StringKey.MFA_SELECT_METHOD to "Dogrulama Yontemini Secin",
    StringKey.MFA_SELECT_METHOD_DESC to "Kimliginizi dogrulamak icin bir yontem secin.",
    StringKey.MFA_VERIFYING to "Dogrulaniyor...",
    StringKey.MFA_ENTER_CODE to "Dogrulama kodunu girin",
    StringKey.MFA_SEND_OTP to "Kod Gonder",
    StringKey.MFA_RESEND_OTP to "Tekrar Gonder",
    StringKey.MFA_OTP_SENT to "Kod basariyla gonderildi.",
    StringKey.MFA_SCAN_QR to "Bu QR kodu baska bir cihazla tarayin.",
    StringKey.MFA_SCAN_QR_CAMERA to "QR Kodu Kamerayla Tara",
    StringKey.MFA_POINT_CAMERA_AT_QR to "Kamerayi QR koduna dogru tutun",
    StringKey.MFA_QR_SCANNED to "QR kod tarandı. Gönderiliyor...",
    StringKey.MFA_BACK_TO_METHODS to "Yontemlere Don",
    StringKey.MFA_VERIFY to "Dogrula",
    StringKey.MFA_SESSION_EXPIRED to "MFA oturumu sona erdi. Lutfen tekrar giris yapin.",
    StringKey.MFA_METHOD_TOTP to "Dogrulama Uygulamasi",
    StringKey.MFA_METHOD_EMAIL_OTP to "E-posta Kodu",
    StringKey.MFA_METHOD_SMS_OTP to "SMS Kodu",
    StringKey.MFA_METHOD_FACE to "Yuz Tanima",
    StringKey.MFA_METHOD_VOICE to "Ses Tanima",
    StringKey.MFA_METHOD_FINGERPRINT to "Parmak Izi",
    StringKey.MFA_METHOD_QR_CODE to "QR Kod",
    StringKey.MFA_METHOD_HARDWARE_KEY to "Donanim Anahtari",
