 ...
 *
 * Ported from practice-and-test/UniversalNfcReader. Emits the shared
 * [MrzInputData] model (doc number, DOB YYMMDD, expiry YYMMDD) that the
 * existing NFC stack already consumes via [INfcService.setMrzData].
 *
...
fun MrzInputDialog(
    onDismiss: () -> Unit,
    onAuthenticate: (MrzInputData) -> Unit,
