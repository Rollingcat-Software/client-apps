...
dependencies {
    ...
    // kotlin.test.* assertions are used by the instrumented tests
    // (TotpVaultTest, ThemePreferencesTest, …) but were only on the JVM
    // unit-test classpath — without this the androidTest source set does not
    // compile.
